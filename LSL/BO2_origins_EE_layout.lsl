...
<Layout version="1.6.1">
  ...
  <VerticalHeight>292</VerticalHeight>
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        ...
        <Split>True</Split>
        <CustomSettings>
          <Setting id="splits" type="bool">True</Setting>
          <Setting id="no_mans_land" type="bool">True</Setting>
          <Setting id="soul_chests" type="bool">True</Setting>
          <Setting id="staff_1" type="bool">True</Setting>
          <Setting id="staff_2" type="bool">True</Setting>
          <Setting id="staff_3" type="bool">True</Setting>
          <Setting id="staff_4" type="bool">True</Setting>
          <Setting id="ee_all_staffs_placed" type="bool">True</Setting>
          <Setting id="end_game" type="bool">True</Setting>
        </CustomSettings>
      </Settings>
    </Component>
  </Components>
